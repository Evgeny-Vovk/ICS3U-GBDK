...
screen_t game () {
    ...
    int alienXPosition = time(0) % 100;
    alienXPosition = 100;
    int alienYPosition = 0;
    for (int alienAmount = 0; alienAmount < 20; alienAmount++) {
        int alienNumber = 10;
        set_meta_sprite_tile(alienNumber, 7, 8, 9, 10);
        alienNumber++;
    }
    move_meta_sprite(10, alienXPosition, alienYPosition);
